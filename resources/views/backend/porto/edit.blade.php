...
@endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="link" id="example-text-input" value="{{ $porto->link }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="category" id="example-text-input" value="{{ $porto->category }}">
