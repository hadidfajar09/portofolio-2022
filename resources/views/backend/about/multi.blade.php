            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Multi Image About</h4> <br><br>
...
@endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="title" id="example-text-input" value="">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="short_title" id="example-text-input" value="">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea required="" name="short_deskripsi" class="form-control" rows="5"></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="elm1" name="long_deskripsi"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="file" name="image" id="image" placeholder="Artisanal kale" id="example-text-input" value="">
                            </div>
                        </div>
