...
<main>
    ...
    <!-- banner-area -->
    @include('frontend.home_section.homeslide')
    <!-- banner-area-end -->

    <!-- about-area -->
   @include('frontend.home_section.home_about')
    <!-- about-area-end -->
    ...
    <!-- portfolio-area -->
    @include('frontend.home_section.home_porto')
    <!-- portfolio-area-end -->
    ...
    <!-- blog-area -->
   @include('frontend.home_section.home_blog')
    <!-- blog-area-end -->
